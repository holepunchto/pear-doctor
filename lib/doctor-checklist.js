...
customElements.define(
  ...
  class extends HTMLElement {
    ...
    async #updatePlatform () {
      ...
      console.log('bootstrapping...', dumpLink, platformDir)
      await pearUpdaterBootstrap(dumpLink, platformDir, { bootstrap: config.dht.bootstrap })
