...
customElements.define(
  ...
  class extends HTMLElement {
    ...
    async #updatePlatform () {
      ...
      const killP = await bootstrapPlatforms()
      const { appLink, kill: killA } = await platformDir1SeedApp()
    ...
    async #updatePlatformDesktopTest () {
      ...
      const killP = await bootstrapPlatforms()
      const { appLink, kill: killA } = await platformDir1SeedApp()
      const killR = await platformDir2RunApp(appLink)
