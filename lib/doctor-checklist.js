...
customElements.define(
  ...
  class extends HTMLElement {
    ...
    #openNurse () {
      const tmp = os.tmpdir()
      const destPath = path.join(tmp, 'nurse.html')
      ...
      fs.writeFile(destPath, data, (err) => {
        if (err) {
          ...
          const command = isWindows ? 'explorer' : isMac ? 'open' : isLinux ? 'xdg-open' : null
          if (!command) return
        ...
        <div id="panel">
          ...
          <div class="list-container">
            <div class="header-container">
              ...
              <action-button action="" type="Nurse" applink="${config.applink}" style="margin-left: 1rem;"></action-button>
            </div>
            <div id="checklist">
