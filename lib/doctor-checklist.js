...
customElements.define(
  ...
  class extends HTMLElement {
    ...
    #startChecks () {
      this.#updateState({ started: true, randomKey: randomBytes(32) })
    }
          ...
          <div>
            ...
            <ul id="link-list">
              ...
              <li>
                ...
                <a id="link5" href="pear://${randomKey.toString('hex')}">pear://${randomKey.toString('hex')}</a>
              </li>
            </ul>
          </div>
        </body>
    ...
    async #checkTrustDialog (randomKey) {
      ...
      const trusted = permits.trusted.some((permit) => encode(randomKey) === permit)
