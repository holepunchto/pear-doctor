...
customElements.define(
  ...
  class extends HTMLElement {
    ...
    #attachEventListeners () {
      ...
      this.shadowRoot.querySelectorAll('action-button').forEach(button => {
        ...
        const listener = (event) => {
          ...
          if (type === 'Nurse') this.#openNurse(this.state.randomKey)
          ...
          if (type === 'Trust-Dialog' && action === 'Check') this.#checkTrustDialog(this.state.randomKey)
        }
    ...
    #startChecks () {
      this.#updateState({ started: true, randomKey: randomBytes(32).toString('hex') })
    }
          ...
          <div>
            ...
            <ul id="link-list">
              ...
              <li>
                ...
                <a id="link5" href="pear://${randomKey}">pear://${randomKey}</a>
              </li>
            </ul>
          </div>
        </body>
