...
customElements.define(
  ...
  class extends HTMLElement {
    ...
    async #updateApp () {
      ...
      await fs.promises.writeFile(path.join(tmpDir, 'index.js'), `Pear.updates((data) => { console.log(JSON.stringify(data)) })`)
      ...
      const updatePromise = new Promise((resolve) => {
        runChild.stdout.on('data', (data) => {
          console.log('data', data.toString(), JSON.parse(data.toString()))
        })
      })
