  ...
  class extends HTMLElement {
    ...
    async #updatePlatform () {
      ...
      const bootstrapPlatforms = async () => {
        ...
        this.#updateState({ 'status-LIFECYCLE_UPDATE_PLATFORM': 'dumping-platform...' })
        ...
        this.#updateState({ 'status-LIFECYCLE_UPDATE_PLATFORM': 'staging-platform...' })
        ...
        this.#updateState({ 'status-LIFECYCLE_UPDATE_PLATFORM': 'seeding-platform...' })
