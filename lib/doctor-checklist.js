...
const ENCRYPTED_APP_KEY = '57ydihsrmdjpidd9jrrf8fp9ahjzn3uasbpz15bo9m7ryxmnwafo'
const ENCRYPTED_APP_PASS = '123456'
const ENCRYPTED_APP_PASS_HASH = '96c90efdf79217c641da6fd4e2df09c3ddcbad7be1e6acda98cf96166ec195729b359cae6f7adc23707bb9a89569517b9bae0c00cf03297d5173098055b20d1362237050e8ccbd4fa113b31ee5860658af10dc18cc76869179045e08c1748bb98504723d66f7'
...
customElements.define(
  ...
  class extends HTMLElement {
          ...
          <div>
            ...
            <ul id="link-list">
              ...
              <li>
                ...
                <br />
                <ul>
                  <li>Close the doctor app, and reopen with this option: pear run --unsafe-clear-preferences pear://doctor</li>
    ...
    #checkPasswordDialog () {
      const permits = JSON.parse(fs.readFileSync(permitsPath, 'utf8'))
      const isCorrectPass = permits['encryption-keys']?.[ENCRYPTED_APP_KEY] === ENCRYPTED_APP_PASS_HASH
      this.#updateState({ LIFECYCLE_PASSWORD_DIALOG: isCorrectPass })
    }
