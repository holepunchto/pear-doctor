...
customElements.define(
  ...
  class extends HTMLElement {
    ...
    async #updatePlatform () {
      const { dumpDir, platformDir1, platformDir2 } = await bootstrapPlatforms()
      const { appLink } = await platformDir1SeedApp()
      const { pipe, updatePromise } = await platformDir2RunApp()
      await platformDir1StageNewFile()
      ...
      async function bootstrapPlatforms () {
        ...
        console.log('bootstrapping...', dumpKey, platformDir1)
        ...
        console.log('bootstrapping...', dumpKey, platformDir2)
        await pearUpdaterBootstrap(dumpKey, platformDir2, { bootstrap: config.dht.bootstrap })

        return { dumpDir, platformDir1, platformDir2 }
      }

      async function platformDir1SeedApp () {
      ...
      async function platformDir2RunApp () {
      ...
      async function platformDir1StageNewFile () {
