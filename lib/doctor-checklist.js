...
customElements.define(
  ...
  class extends HTMLElement {
    ...
    async #updateApp () {
      ...
      const stageOut = await spawnUntil(stageChild, 'addendum')
      ...
      const stageOut2 = await spawnUntil(stageChild2, 'addendum')
