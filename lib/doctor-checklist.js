...
const SALT = b4a.from('d134aa8b0631f1193b5031b356d82dbea214389208fa4a0bcdf5c2e062d8ced2', 'hex');
...
customElements.define(
  ...
  class extends HTMLElement {
    ...
    #resetChecks () {
      ...
      this.randomKey = randomBytes(32).toString('hex')
      fs.rmSync(permitsPath, { force: true, recursive: true })
    }
    ...
    async #checkPasswordDialog () {
      const encryptedKey = await pwToEk(ENCRYPTED_APP_PASS, SALT)
      const permits = JSON.parse(fs.readFileSync(permitsPath, 'utf8'))
      const isCorrectPass = permits['encryption-keys']?.[ENCRYPTED_APP_KEY] === encryptedKey.toString('hex')
