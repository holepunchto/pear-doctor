...
customElements.define(
  ...
  class extends HTMLElement {
    ...
    async #updateAppDesktopTest () {
      const statusId = 'status-LIFECYCLE_UPDATE_APP_DESKTOP'
      ...
      runChild.on('exit', (code, signal) => console.log(`Run app exited with code: ${code}, signal: ${signal}`))

      // TODO: fix this test in pear-next: app does not open, console error 'Run app exited with code: null, signal: SIGABRT'
    }
    ...
    async #updatePlatformDesktopTest () {
      ...
      // TODO: fix this test in pear-next: app does not open
    }
