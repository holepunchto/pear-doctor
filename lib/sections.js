...
export const sections = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        tooltip:
          'Make sure this app is closed. Then, open the app by clicking a link with an invite code of type Keet: [app-key]/xeb7mugj8...',
        activeFromLength: 0
      }
    ]
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        text: 'Legacy invite code - link click loads invite code as fragment',
        tooltip:
          'Make sure this app is already open. Then, click a link with an invite code of type Keet: [app-key]/xeb7mugj8...',
        tooltipInactive:
          "This check is disabled pending a platform update with <a href='https://github.com/holepunchto/pear/pull/222'>PR 222 - Include fragment to wakeup message</a>",
        activeFromLength: 0
      }
    ...
    items: [
      {
        id: 'TRAY_DEFAULT',
        text: 'Tray - default',
        tooltip: 'Run Pear.tray() to show the default tray',
        button: 'action-button',
        action: 'Run',
        type: 'Tray-Default',
        buttonSecond: 'action-button',
      ...
      },
      {
        ...
        tooltip: 'Run Pear.tray({ icon }) to show the tray with custom icon',
        button: 'action-button',
        action: 'Run',
      ...
      },
      {
        ...
        tooltip: 'Run Pear.tray({ menu }) to show the tray with custom menu',
        button: 'action-button',
        action: 'Run',
      ...
      },
      {
        ...
        tooltip:
          'Run Pear.tray() multiple times, only the last one should be shown',
        button: 'action-button',
        action: 'Run',
