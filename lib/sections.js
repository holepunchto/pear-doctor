    ...
    items: [
      {
        ...
        tooltip: 'Make sure this app is closed. Then, open the app by clicking the link: pear://doctor',
        activeFromLength: 0
      },
      {
        id: 'COLD_START_FRAGMENT',
        text: 'Fragment - link click loads fragment',
        tooltip: 'Make sure this app is closed. Then, open the app by clicking the link: pear://doctor/#fragment',
        activeFromLength: 0
      },
      {
        id: 'COLD_START_ENTRYPOINT',
        text: 'Entrypoint - link click loads entrypoint',
        tooltip: 'Make sure this app is closed. Then, open the app by clicking the link: pear://doctor/nested/entrypoint.html',
        activeFromLength: 0
      },
      {
        id: 'COLD_START_ENTRYPOINT_FRAGMENT',
        text: 'Entrypoint fragment - link click loads entrypoint with fragment',
        tooltip: 'Make sure this app is closed. Then, open the app by clicking the link: pear://doctor/nested/entrypoint.html#fragment',
        activeFromLength: 0
      },
      {
        id: 'COLD_START_INVITE_CODE',
        text: 'Legacy invite code - link click loads invite code as fragment',
        tooltip: 'Make sure this app is closed. Then, open the app by clicking a link with an invite code of type Keet: pear://doctor/xeb7mugj8...',
        activeFromLength: 0
      }
    ]
  },
    ...
    items: [
      {
        ...
        tooltip: 'Make sure this app is already open. Then, click the link: pear://doctor>',
        activeFromLength: 0
      },
      {
        ...
        link: 'doctor/?source=inside-app',
        activeFromLength: 0
      },
      {
        id: 'WAKE_UP_FRAGMENT',
        text: 'Fragment - link click loads fragment while app is open',
        tooltip: 'Make sure this app is already open. Then, click the link: pear://doctor/nested/entrypoint.html#fragment',
      ...
      },
      {
        ...
        text: 'Entrypoint - link click loads entrypoint',
        tooltip: 'Make sure this app is already open. Then, click the link: pear://doctor/nested/entrypoint.html',
        tooltipInactive: 'This check is disabled pending a platform update with <a href=\'https://github.com/holepunchto/pear/pull/222\'>PR 222 - Include fragment to wakeup message</a>',
        activeFromLength: 4041
      },
      {
      ...
      },
      {
        ...
        text: 'Legacy invite code - link click loads invite code as fragment',
        tooltip: 'Make sure this app is already open. Then, click a link with an invite code of type Keet: pear://doctor/xeb7mugj8...',
        tooltipInactive: 'This check is disabled pending a platform update with <a href=\'https://github.com/holepunchto/pear/pull/222\'>PR 222 - Include fragment to wakeup message</a>',
        activeFromLength: 4041
      }
    ]
