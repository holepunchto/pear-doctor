...
export const sections = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        tooltip: 'Make sure this app is closed. Then, open the app by clicking the link: [app-key]/?query',
        activeFromLength: 0
      },
      {
      ...
      },
      {
        ...
        tooltip: 'Make sure this app is closed. Then, open the app by clicking the link: [app-key]/nested/entrypoint.html?query',
        activeFromLength: 0
      }
    ]
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        tooltip: 'Make sure this app is already open. Then, click the link: [app-key]/#fragment',
      ...
      },
      {
        ...
        tooltip: 'Make sure this app is already open. Then, click the link: [app-key]/?query',
        activeFromLength: 0
      },
      {
      ...
      },
      {
        ...
        text: 'Entrypoint Query - link click loads entrypoint with query',
        tooltip: 'Make sure this app is already open. Then, click the link: [app-key]/nested/entrypoint.html?query',
        activeFromLength: 0
      }
    ]
  },
      ...
      }]),
  {
    ...
    items: [
      ...
      },
      {
        ...
        text: 'Teardown - normal exit (less than 15s after quit)',
      ...
      },
      {
        ...
        text: 'Teardown - reject exit (less than 15s after quit)',
      ...
      },
      {
        ...
        text: 'Teardown - force exit (timeout in 15s after quit)',
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        tooltip: 'Click the close action to run the worker and exit the app. Reopen the app and check if previous worker has exited.',
        button: 'action-button',
        action: 'Crash',
      ...
      },
      {
        ...
        tooltip: 'Click the crash action to run the worker and crash the app. Reopen the app and check if previous worker has exited.',
        button: 'action-button',
        action: 'Crash',
    ...
    items: [
      {
        id: 'TRAY_DEFAULT',
        text: 'Tray - default',
        tooltip: 'Run Pear[Pear.constructor.UI].app.tray() to show the default tray',
        button: 'action-button',
        action: 'Run',
        type: 'Tray-Default',
        buttonSecond: 'action-button',
      ...
      },
      {
        ...
        tooltip: 'Run Pear[Pear.constructor.UI].app.tray({ icon }) to show the tray with custom icon',
        button: 'action-button',
        action: 'Run',
      ...
      },
      {
        ...
        tooltip: 'Run Pear[Pear.constructor.UI].app.tray({ menu }) to show the tray with custom menu',
        button: 'action-button',
        action: 'Run',
      ...
      },
      {
        ...
        tooltip: 'Run Pear[Pear.constructor.UI].app.tray() multiple times, only the last one should be shown',
        button: 'action-button',
        action: 'Run',
