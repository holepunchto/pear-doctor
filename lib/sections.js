    ...
    items: [
      {
        ...
        tooltip:
          'First, make sure no other pear commands are running in other terminals. Then, click to check if there are any zombie sidecar processes in the system.',
        button: 'action-button',
        action: 'Check',
        type: 'Zombie-Sidecar',
        activeFromLength: 0
      ...
      },
      {
        ...
        tooltip:
          'First, click the Random key in Nurse, trust dialog will appear, trust and confirm that. Then click Check (click Reset to generate a new random key)',
        button: 'action-button',
        action: 'Check',
        type: 'Trust-Dialog',
        activeFromLength: 0
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        tooltip: 'Run ui.app.tray() multiple times, only the last one should be shown',
        button: 'action-button',
        action: 'Run',
