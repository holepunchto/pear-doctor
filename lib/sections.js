...
export const sections = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        id: 'WORKER_PARENT_PIPE_END',
        text: 'Worker exit - on parent pipe end',
        tooltip: 'Click the close action to run the worker, close the pipe and check if worker has exited.',
        button: 'action-button',
        action: 'End',
        type: 'Worker-Parent-Pipe-End',
        activeFromLength: 0
      }
    ]
  }
