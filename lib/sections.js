  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        tooltip: 'Click the action, close the app, and wait for the app to exit normally',
        button: 'action-button',
        action: 'Check',
      ...
      },
      {
        ...
        tooltip: 'Click the action, close the app, and wait for the app to exit forcefully',
        button: 'action-button',
        action: 'Check',
        type: 'Teardown-Force',
        activeFromLength: 0
